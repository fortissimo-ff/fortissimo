...
2) Raise an [issue](https://github.com/fortissimo-ff/fortissimo-landing-page-android/issues) by indicating a title for the new issue (the numbering of the issue with e.g. #1, #2, #3, #4, etc. is automatically generated), what the issue is, why is it an issue, what needs improvement or fixing, and what can be done to improve or fix it. 
